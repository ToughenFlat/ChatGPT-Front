	...
	<view>
		...
		:animation="animationData" >		
			<view class="bottom-dh-char flex-row-around" style="font-size: 55rpx;">
				<!-- vue无法使用软键盘"发送" -->
				 <input  v-model="msg"  class="dh-input chatMessageDis" type="text" style="background-color: #f0f0f0;" 
				 @confirm="sendMsg" confirm-type="search" placeholder-class="my-neirong-sm"
				 placeholder="用一句简短的话描述您的问题" /> 
				 <view @click="sendMsg" class="cu-tag bg-cyan round chatMessageDis">
				 	发送
				 </view>
				<text @click="ckAdd" class="cuIcon-roundaddfill text-brown chatMessageDis"></text>
			</view>		
				<!-- 附加栏(自定义) -->
